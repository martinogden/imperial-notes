...
\NotesSubTitle{1st}{Spring 2015}{Mathematical Methods II}{Prof.~M.}{Barahona}
{
\subsection*{Syllabus}
...
These are equations of the form: \lecturemarker{3}{20th Jan}
...
\subsubsektion{Case (1) - $\dfrac{d^2y}{dx^2} = f(x)$}
...
\subsubsektion{Case (2) - $\dfrac{d^2y}{dx^2} = f\left(x,\dfrac{dy}{dx}\right)$}
...
\subsubsektion{Case (3) - $\dfrac{d^2y}{dx^2} = f(y)$} 
...
\subsubsektion{Case (4) - $\dfrac{d^2y}{dx^2} = f\left(y,\dfrac{dy}{dx}\right)$}
